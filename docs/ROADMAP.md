...
This roadmap defines eight incremental releases. Each version ships a working product before advanced features begin. **Version 1 is the current implementation target.**
