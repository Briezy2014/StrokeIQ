...
android {
    ...
    defaultConfig {
        ...
        buildConfigField(
            "String",
            "SUPABASE_URL",
            "\"${localProp("SUPABASE_URL", "https://bryurwyeosbffvfpdpbv.supabase.co")}\"",
        )
        buildConfigField(
            "String",
            "SUPABASE_KEY",
            "\"${localProp("SUPABASE_KEY", "sb_publishable_Xzy-xAEqOM-0Nh3Ig7MiTg_n4986BvS")}\"",
        )
    }
