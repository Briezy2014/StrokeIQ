...
git checkout origin/cursor/windows-chrome-spaces-fix-17e8 -- LAUNCH-CHROME.bat FIX-KARA-PATHS.bat DIAGNOSE.bat restore-scripts.ps1 COPY-LOGO.bat DRAG-LOGO-HERE.bat ZIP-GODADDY-UPLOAD.bat
