  ...
  static List<MeetResult> _meetResults() {
    ...
    return [
      ...
      MeetResult(
        ...
        notes: 'PB — best race of the year.',
      ),
      MeetResult(
        id: 9203,
        swimmerName: name,
  ...
  static List<SwimScheduleEntry> _schedules(DateTime clock) {
    ...
    return [
      ...
      SwimScheduleEntry(
        ...
        notes: 'Goal: SCY 100 Fly under 1:01.5',
